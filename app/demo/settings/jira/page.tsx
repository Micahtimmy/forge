...
export default function DemoJiraSettingsPage() {
  ...
  const handleConnect = () => {
    toast.info("Demo Mode", "In demo mode, JIRA connection is simulated");
    setIsConnected(true);
  };
            ...
            <div className="mt-4 pt-4 border-t border-border">
              <div className="grid grid-cols-2 gap-4 text-sm">
                ...
                <div>
                  ...
                  <div className="text-text-primary font-medium">156 stories</div>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="bg-surface-01 border border-border rounded-lg p-5 space-y-4">
            ...
            <div className="pt-4 border-t border-border flex items-center gap-3">
              ...
              <Button
                ...
                onClick={() => toast.info("Demo mode", "Would open JIRA in new tab")}
              >
                Open JIRA
              </Button>
            </div>
