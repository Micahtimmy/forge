...
const DEMO_RUBRICS: Rubric[] = [
  ...
  {
    id: "fintech",
    name: "FinTech Compliance Rubric",
    description: "Includes compliance and security considerations for financial services",
    isDefault: false,
    dimensions: [
      { id: "completeness", name: "Completeness", description: "Story has all required fields", maxScore: 20, enabled: true },
      { id: "clarity", name: "Clarity", description: "Story is clearly written", maxScore: 20, enabled: true },
      { id: "security", name: "Security", description: "Security implications documented", maxScore: 20, enabled: true },
      { id: "compliance", name: "Compliance", description: "Regulatory requirements addressed", maxScore: 15, enabled: true },
      { id: "testability", name: "Testability", description: "Verifiable acceptance criteria", maxScore: 15, enabled: true },
      { id: "auditability", name: "Auditability", description: "Audit trail requirements specified", maxScore: 10, enabled: true },
    ],
