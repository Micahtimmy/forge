  ...
  return (
    <DropdownMenuPrimitive.SubTrigger
      className={cn(
        ...
        "focus:bg-surface-03 data-[state=open]:bg-surface-03",
        "text-text-primary",
        inset && "pl-8",
        className
      )}
...
function DropdownMenuSubContent({
  ...
  return (
    <DropdownMenuPrimitive.SubContent
      className={cn(
        "z-50 min-w-[8rem] overflow-hidden rounded-lg border border-border bg-surface-02 p-1 shadow-lg",
...
function DropdownMenuRadioItem({
  ...
  return (
    ...
    >
      <span className="absolute left-2 flex h-3.5 w-3.5 items-center justify-center">
        <DropdownMenuPrimitive.ItemIndicator>
          <Circle className="h-2 w-2 fill-iris text-iris" />
        </DropdownMenuPrimitive.ItemIndicator>
      </span>
      {children}
    </DropdownMenuPrimitive.RadioItem>
...
function DropdownMenuShortcut({
  ...
  return (
    <span
      className={cn(
        "ml-auto text-xs tracking-widest text-text-tertiary font-mono",
        className
      )}
      {...props}
    />
